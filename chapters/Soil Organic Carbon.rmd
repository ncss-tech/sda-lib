...
```
![](https://github.com/ncss-tech/sda-lib/blob/master/TableImages/SOC_Main.JPG)
...
```
![](https://github.com/ncss-tech/sda-lib/blob/master/TableImages/SOC_ACPF.JPG)
...
```
![](https://github.com/ncss-tech/sda-lib/blob/master/TableImages/SOC_muacpf.JPG)
...
```
![](https://github.com/ncss-tech/sda-lib/blob/master/TableImages/SOC_muacpf2.JPG)
...
```
![](https://github.com/ncss-tech/sda-lib/blob/master/TableImages/SOC_hortopdepth.JPG)
...
```
![](https://github.com/ncss-tech/sda-lib/blob/master/TableImages/SOC_ACPF2.JPG)
...
FROM #acpf
```
![](https://github.com/ncss-tech/sda-lib/blob/master/TableImages/SOC_acpfhzn.JPG)
...
```
![](https://github.com/ncss-tech/sda-lib/blob/master/TableImages/SOC_SOC.JPG)
...
```
![](https://github.com/ncss-tech/sda-lib/blob/master/TableImages/SOC_SOC2.JPG)
...
FROM #SOC2
```
![](https://github.com/ncss-tech/sda-lib/blob/master/TableImages/SOC_SOC3.JPG)
