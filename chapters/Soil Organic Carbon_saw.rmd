...
### MapUnit Table
This table selects a given area of interst. For Entire SSURGO use "areasymbol  <> 'US'" OR STATSGO use "areasymbol = 'US'Areasymbol. This is an example from areasymbol = 'WI025'.
...
Layer variables used in SOC stock calculation (r denotes that the value is representative of the central tendency):
   ...
   * om_r = layer organic matter (%) content. US soil survey databases report OM (NSSH, 2017 )this is typically based on measurement of total combustion carbon and calcium carbonate concentration by calcimeter (KSSL, 2014). 
...
__??is this table actually used??__
