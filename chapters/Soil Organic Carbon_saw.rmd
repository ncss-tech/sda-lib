...
General Information about this query:
   ...
   * Layer SOC stock =  (hzT * ( ( om / 1.724 ) * db3 ) * (100.0 - fragvol) / 100.0)
        + Where hzT = horizon thickness, om = organic matter, db3 = bulk density and fragvol = coarse fragments.  Details in following text.
...
Pedon SOC stock ($SOCstock_D$) were summed for soil depths (D) of 0-5, 0-30, and 0-100cm using the fixed depth increment approach described by Ellert et al. (2008) 
